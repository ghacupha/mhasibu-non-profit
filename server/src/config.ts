...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'mhasibuNonProfit';
    ...
    'jhipster.mail.from' = 'mhasibuNonProfit@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'mhasibuNonProfit API';
    'jhipster.swagger.description' = 'mhasibuNonProfit API documentation';
    ...
    'eureka.instance.appname' = 'mhasibuNonProfit';
    'eureka.instance.instanceId' = 'mhasibuNonProfit:${random.value}';
    ...
    'cloud.config.name' = 'mhasibuNonProfit';
