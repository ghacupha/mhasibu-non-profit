...
describe('Component Tests', () => {
  describe('TransactionAccount Management Component', () => {
    let comp: TransactionAccountComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TransactionAccountComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.transactionAccounts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
