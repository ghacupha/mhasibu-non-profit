...
describe('TransactionSignature e2e test', () => {
  ...
  it('should create and save TransactionSignatures', async () => {
    ...
    await promise.all([
      ...
      transactionSignatureUpdatePage.setTransactionTimeInput('01/01/2001' + protractor.Key.TAB + '02:30AM'),
    ...
    expect(await transactionSignatureUpdatePage.getTransactionTimeInput()).to.contain(
      '2001-01-01T02:30',
      'Expected transactionTime value to be equals to 2000-12-31'
    );
